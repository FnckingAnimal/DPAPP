...
import app.cmapp.staticBianliang.e4DevicenoStaticdata;
import app.dpapp.R;
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                if (msg.what == 0) {
                    ...
                    As1 = new ArrayAdapter<>(e4devicenomap.this, R.layout.support_simple_spinner_dropdown_item, ls);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (sp_deviceno.getSelectedItem() != null && !"".equals(sp_deviceno.getSelectedItem())) {
                    ...
                    MyThreadPool.pool.execute(new Runnable() {
                        ...
                        public void run() {
                            MSSFCSOAP sfcsoap = new MSSFCSOAP();
                            List<E4DevicenoBean> ls1 = sfcsoap.sfc_getdevicenoInfo(deviceno, Staticdata.type);
                            Message msg = new Message();
                            msg.what = 0;
                            msg.obj = ls1;
