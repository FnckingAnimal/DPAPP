                        ...
                        try {
                            ...
                            if (lly1 != null) {
                                for (int i = 0; i < lly1.getChildCount() - 1; i++) {
                                    ...
                                    ls.add("[" + ((TextView) lly1.getChildAt(i).findViewById(R.id.Mitemid1)).getText().toString() + "],["
                ...
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (ls != null && ls.size() > 0) {
                                r = Exectempfile.instance().savefile222(Eqid + "_" + Filerevsion, ls);
                            }
...
//                                        } else {
//                                            try {
//                                                if (temp2.trim().equals("/") || temp2.trim().equals("")) {
//                                                    ((TextView) lly1.getChildAt(i).findViewById(R.id.Mvalue1)).setTextColor(Color.RED);
//                                                    checkdatastatus = false;
//                                                } else if (Float.parseFloat(strArray[1]) > Float.parseFloat(temp2) || Float.parseFloat(strArray[2]) < Float.parseFloat(temp2)) {
//
//                                                    ((TextView) lly1.getChildAt(i).findViewById(R.id.Mvalue1)).setTextColor(Color.RED);
//                                                    if (clicktimes < 2) {
//                                                        checkdatastatus = false;
...
//                            }
                            if (tempspecvalue1.equals("1") || tempspecvalue1.equals("2") || tempspecvalue1.equals("5") || tempspecvalue1.equals("6")) {
                                ...
                                if (str.length() > 1) {
                                    tempspecvalue2 = Sourcelist.get(i).getValuespec().trim().substring(2, Sourcelist.get(i).getValuespec().trim().length());
                                } else {
                                    tempspecvalue2 = null;
                                }
                            }
                            ...
                            if (tempspecvalue1.equals("6")) {
                                ...
                                if (tempspecvalue1.equals("4") && Sourcelist.get(i).getItemname().contains("班別")) {
                ...
                v.setOnClickListener(
                        new View.OnClickListener() {
                            ...
                            public void onClick(final View v1) {
                                ...
                                builder.setTitle("選擇");
                                builder.setPositiveButton("上傳圖像", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
