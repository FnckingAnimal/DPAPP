...
import app.cmapp.CheckNewBean;
import app.cmapp.PysBean;
import app.cmapp.PysBean3;
import app.cmapp.PysBenTwo;
import app.cmapp.Staticdata;
import app.cmapp.TestBean;
import app.cmapp.machinecheck.MPBean;
...
public class PublicSOAP {
     ...
     * @return
     */
    public  String getRemoteInfo_eqrepairstartrepair(String userid,String password,String Eqid,String IP)
    {
        try {
            String NAMESPACE = "http://tempuri.org/";
    ...
    * @return
            */
    public  List<eqchecktaskcls> getRemoteInfo_eqchecktasknew(String tablename, String userid, String location, String line, String machine, String deviceno)
    {
        try {
            String NAMESPACE = "http://tempuri.org/";
 ...
 /**
     ...
     * @return
     */
    public  List<String> getRemoteInfo_geteqcheckdevicenolh(String type) {
...
//                ls1.add("");
     ...
     * @return
     */
    public  List<String> getRemoteInfo_geteqchecklocationlh(String deviceno) {
...
//            http://10.185.16.115:8096/Service.asmx?op=deletecheckdata
     ...
     * @return
     */
    public  List<String> getRemoteInfo_geteqcheckopnamelh(String floor,String linename,String deviceno) {
