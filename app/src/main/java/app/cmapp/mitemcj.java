...
import app.cmapp.E4SFC.e4devicenomap;
import app.cmapp.IncludingSFC.devicenomap;
import app.cmapp.IncludingSFC.expendable;
import app.cmapp.IncludingSFC.geterpissueorder;
import app.cmapp.Repair.eqrepairexec;
import app.cmapp.Repair.eqrepairtask;
import app.cmapp.Reserve.rsstrocklist;
import app.cmapp.Reserve.rsstrocktask;
import app.cmapp.appcdl.MyThreadPool;
import app.cmapp.machinecheck.eqchecktask;
import app.cmapp.machinecheck.machine_MP;
import app.cmapp.machinecheck.machine_offline;
import app.cmapp.mgrbc.mgrbceqcheck;
import app.cmapp.zxing.activity.CaptureActivity;
import app.cmapp.IncludingSFC.mcmaterialcall;
import app.cmapp.OtherForm.jcwaferiqcinspectionreport;
...
//        loadform();
    ...
    public void linkeqrepair(View v) {
        Toast.makeText(this,"请使用新版报修!",Toast.LENGTH_SHORT).show();
//        shortmapid = "EQREPAIR";
//        Intent openCameraIntent = new Intent(this, CaptureActivity.class);
//        startActivityForResult(openCameraIntent, 0);
...
//                    startActivity(intentUnusual);
                    break;
                case "output":
                    Intent intentOutput = new Intent(this, Output.class);
                    intentOutput.putExtra("machinenoid", scanResult);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "mitemcj Page", // TODO: Define a title for the content shown.
