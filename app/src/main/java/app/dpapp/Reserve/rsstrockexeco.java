...
public class rsstrockexeco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (reasonno.equals("9")) {
            ...
            ArrayAdapter<String> as2 = new ArrayAdapter<String>(this, R.layout.spinner_textview, dl3);
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                if (msg.what == 0) {
                    ...
                    ArrayAdapter<String> as1 = new ArrayAdapter<String>(rsstrockexeco.this, R.layout.spinner_textview, pe1);
