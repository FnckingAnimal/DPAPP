...
import app.dpapp.Repair.eqrepairengdatain;
import app.dpapp.Repair.eqrepiaraccept;
...
public class systest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter aad=new ArrayAdapter(this,R.layout.spinner_textview, ls);
        et1.setAdapter(aad);

        ArrayAdapter aad2=new ArrayAdapter(this,R.layout.spinner_textview, ls2);
        et2.setAdapter(aad2);

        ArrayAdapter aad3=new ArrayAdapter(this,R.layout.spinner_textview, ls3);
        et6.setAdapter(aad3);

        ArrayAdapter aad4=new ArrayAdapter(this,R.layout.spinner_textview, ls4);
        et7.setAdapter(aad4);
    }
