...
public class eqrepairexec extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Wifi网络申请，暂行赋值，VM测试
        final app.dpapp.Staticdata app = (app.dpapp.Staticdata) getApplication();
...
*/
        ...
        li1.add(h12);
        getkeyindatainput(app.dpapp.Staticdata.httpurl + "machinedata/machine_accept.ashx", li1, 2);
