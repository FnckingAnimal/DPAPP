...
//              zhubie = mList2.get(position).getZHUBIE();
        ...
        mManList.add("陳昭平");
        mManList.add("羅杰");
        mManAdapter = new ArrayAdapter<>(this, R.layout.spinner_textview, mManList);
...
//        mCategoryAdapter = new ArrayAdapter<>(this, R.layout.spinner_textview, mCategoryList);
...
//                        zhubie = mList2.get(0).getZHUBIE();
                        ...
                        mXiangMuAdapter = new ArrayAdapter<>(TestActivity.this, R.layout.spinner_textview, list);
            ...
            switch (msg.what) {
                case 0:
                    ...
                    if(list2 != null) {
                        ...
                        mCategoryAdapter = new ArrayAdapter<>(TestActivity.this, R.layout.spinner_textview, mCategoryList);
                        mCategorySpinner.setAdapter(mCategoryAdapter);
