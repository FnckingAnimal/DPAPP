 ...
 * together with a {@link asmack.org.jivesoftware.smack.filter.PacketFilter} so that only
 ...
 *
 * @see Connection#addPacketInterceptor(PacketInterceptor, asmack.org.jivesoftware.smack.filter.PacketFilter)
